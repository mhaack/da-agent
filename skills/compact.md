...
description: Condenses a long conversation into a structured summary to free context-window space. Call compact_context tool with five required sections when auto-compact triggers or the user requests it.
---
